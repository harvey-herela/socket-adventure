...
class Server(object):
    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def room_description(self, room_number):
        ...
        descriptions = dict()
        descriptions[0] = "You have entered the hall of choices."
        descriptions[1] = "You have entered the cave of the Angry Ogre. Hope you have your affairs in order!"
        descriptions[2] = "You have entered the cave of the Friendly Ogre. It's not as good as it sounds..."
        descriptions[3] = "You have entered the cave of the Stinky Ogre. It doesn't get worse than this."

        if room_number not in descriptions:
            return "Unknown room!"
    ...
    def say(self, argument):
        ...
        self.output_buffer = f'Your final words are, "{argument}"'
    ...
    def quit(self, argument):
        ...
        self.done = True
        self.output_buffer = "Goodbye! Next time, make sure you bring you de-ogre-ant."


    def unknown_cmd(self, argument):
        """
        This is the function that is called when an unknown command is received.
        """
        self.done = True
        self.output_buffer = "Unknown command, quitting. Next time, read the manual."
    ...
    def route(self):
        ...
        known_commands = dict()
        known_commands['quit'] = self.quit
        known_commands['move'] = self.move
        known_commands['say'] = self.say
        known_commands.get(command, self.unknown_cmd)(arguments)
